...
\documentclass[11pt]{article} % font size 11pt as per guideline

\usepackage[margin=0.65in, a4paper]{geometry} % Margin 0.65in as per guidelines
\setcounter{secnumdepth}{0} % remove section numbering
\usepackage{titlesec}
\titlespacing{\subsection}{0pt}{*0}{*0} % remove vertical spacing above and below
\titlespacing{\subsubsection}{0pt}{*0}{*0}

% Uses Computer Modern (default LaTeX font)
...
\linespread{1.3} % Set line spacing to 1.3 as recommended

% Add 6pt space after paragraphs as per guidelines
\parskip=6pt
