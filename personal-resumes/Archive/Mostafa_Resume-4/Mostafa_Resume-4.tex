...
% Modern font setup (closest to Inter/Montserrat strategy available in standard LaTeX)
\usepackage[T1]{fontenc}
\usepackage{tgheros}      % TeX Gyre Heros - modern sans-serif similar to Helvetica Neue
\usepackage{textcomp}
...
% Section title formatting (as in Montserrat style)
\titleformat{\section}
    {\Large\bfseries\selectfont} % 14pt bold
    {}
    {0em}
    {}
    [\vspace{-0.5em}]
...
\renewcommand{\baselinestretch}{1.25}  % Line spacing as recommended: 1.25
